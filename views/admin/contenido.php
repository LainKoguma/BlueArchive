...
<body class="hold-transition sidebar-mini sidebar-collapse">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tipo">Logo</label>
                                <input type="file" class="form-control" id="tipo"
                                    placeholder="Tu logo">
                            </div>
                            <!-- /.form-group -->
                        </div>
        ...
        $.ajax({
          ...
          <div class="col-12">
            ...
            for (var x = 0; x < mensaje.msg; x++) {
                ...
                tabla += '<td>' + mensaje.fila[x]["Nombre"] + '</td>'
                tabla += '<td>' + mensaje.fila[x]["Logo"] + '</td>'
                tabla +=
    ...
    function editservices(id) {
        ...
        $.ajax({
            ...
            contenido.value = mensaje.fila[0]["Nombre"]
            tipo.value = mensaje.fila[0]["Logo"]
        })
    }
