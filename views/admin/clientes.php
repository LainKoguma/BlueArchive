...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Editar informacion de contacto</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Clientes Atendidos</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Numero de clientes">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Proyectos Realizados</label>
                                <input type="text" class="form-control" id="exampleInputproyectos" placeholder="Numero de proyectos">
                                <input id="exampleInputid" hidden>
                            </div>
                            <!-- /.form-group -->
                        </div>
    ...
    document.getElementById("agregarservicio").addEventListener('click', () => {
        ...
        var clientes = document.getElementById("exampleInputEmail1").value
        var proyectos = document.getElementById("exampleInputproyectos").value
        datos = {
        ...
        $.ajax({
          ...
          <div class="col-12">
            ...
            for (var x = 0; x < mensaje.msg; x++) {
                ...
                tabla += '<td>' + mensaje.fila[x]["clientes"] + '</td>'
                tabla += '<td>' + mensaje.fila[x]["proyectos"] + '</td>'
                tabla +=
    ...
    function editservices(id) {
        ...
        var clientes = document.getElementById("exampleInputEmail1")
        var proyectos = document.getElementById("exampleInputproyectos")
        datos = {
        ...
        $.ajax({
            ...
            clientes.value = mensaje.fila[0]["clientes"]
            proyectos.value = mensaje.fila[0]["proyectos"]
        })
    }
